...
(function () {
  ...
  PAGES.partner = {
    ar: {
      ...
      'p.k4': 'وجبات سريعة', 'p.k5': 'دجاج وبروست', 'p.k6': 'مأكولات بحرية',
      'p.k7': 'حلويات ومخبوزات', 'p.k8': 'قهوة ومشروبات', 'p.k9': 'مطبخ آسيوي', 'p.k10': 'أخرى',
      'p.count': 'كم مطعماً تملك؟', 'p.c1': 'مطعم واحد', 'p.c2': 'مطعمان',
      'p.c3': '٣ – ٥ مطاعم', 'p.c4': 'أكثر من ٥',
    ...
    en: {
      ...
      'p.k4': 'Fast food', 'p.k5': 'Chicken & broast', 'p.k6': 'Seafood',
      'p.k7': 'Desserts & bakery', 'p.k8': 'Coffee & drinks', 'p.k9': 'Asian', 'p.k10': 'Other',
      'p.count': 'How many restaurants do you own?', 'p.c1': 'One restaurant', 'p.c2': 'Two',
      'p.c3': '3 – 5', 'p.c4': 'More than 5',
    ...
    bn: {
      ...
      'p.k4': 'ফাস্ট ফুড', 'p.k5': 'চিকেন ও ব্রোস্ট', 'p.k6': 'সামুদ্রিক খাবার',
      'p.k7': 'মিষ্টি ও বেকারি', 'p.k8': 'কফি ও পানীয়', 'p.k9': 'এশিয়ান', 'p.k10': 'অন্যান্য',
      'p.count': 'আপনার কয়টি রেস্টুরেন্ট আছে?', 'p.c1': 'একটি', 'p.c2': 'দুটি',
      'p.c3': '৩ – ৫', 'p.c4': '৫-এর বেশি',
    ...
    ur: {
      ...
      'p.k4': 'فاسٹ فوڈ', 'p.k5': 'چکن اور بروسٹ', 'p.k6': 'سمندری غذا',
      'p.k7': 'میٹھا اور بیکری', 'p.k8': 'کافی اور مشروبات', 'p.k9': 'ایشیائی', 'p.k10': 'دیگر',
      'p.count': 'آپ کے کتنے ریستوران ہیں؟', 'p.c1': 'ایک ریستوران', 'p.c2': 'دو',
      'p.c3': '۳ – ۵', 'p.c4': '۵ سے زیادہ',
    ...
    id: {
      ...
      'p.k4': 'Cepat saji', 'p.k5': 'Ayam & broast', 'p.k6': 'Makanan laut',
      'p.k7': 'Manisan & roti', 'p.k8': 'Kopi & minuman', 'p.k9': 'Asia', 'p.k10': 'Lainnya',
      'p.count': 'Berapa restoran yang Anda miliki?', 'p.c1': 'Satu restoran', 'p.c2': 'Dua',
      'p.c3': '3 – 5', 'p.c4': 'Lebih dari 5',
  ...
  PAGES.fleet = {
    ar: {
      'fl.pill': '✦ للمنشآت المرخّصة',
      'fl.h1': 'أنت تدير كباتنك<br><span>ونحن نأتي بالطلبات</span>',
      'fl.lede': '<b>أسطولك يعمل باسمك، وطلباتنا تملأ يومه.</b> لوحة تشغيل ترى فيها كباتنك وحدهم على الخريطة، ودفتر مستحقات مكشوف سطراً سطراً.',
      'fl.gate': 'قبل أن تكمل: هذه الصفحة للمنشآت المرخّصة وحدها.',
      'fl.gated': 'اللائحة التنفيذية لنشاط توصيل الطلبات لا تسمح لنا بالتعاقد إلا مع منشأةٍ مرخّصة من هيئة النقل، أو سعوديٍّ بمركبته بوثيقة عمل حر. فإن كنت كابتناً تريد العمل بنفسك فبابك <a href="/join/">صفحة الانضمام للكباتن</a> لا هذه.',
      'fl.sec1': 'ماذا تحصل <span>عليه</span>', 'fl.sec1lead': 'لا وعوداً عامة — هذه لوحةٌ تعمل اليوم.',
      'fl.f1t': 'كباتنك وحدهم', 'fl.f1d': 'لوحةٌ تعرض فريقك أنت لا غيره: حالة كلٍّ منهم، وطلبه الجاري، وأداؤه.',
      'fl.f2t': 'خريطة حيّة', 'fl.f2d': 'ترى أين كباتنك الآن، فتوزّعهم على الأحياء بدل أن تسأل واحداً واحداً.',
      'fl.f3t': 'تضمّ كباتنك بنفسك', 'fl.f3d': 'تُصدر كود دعوة لكابتنك فيقدّم بمستنداته — والإدارة تعتمده، فلا يلتحق أحدٌ بأسطولك دون فحص.',
      'fl.f4t': 'دفتر مكشوف', 'fl.f4d': 'كل توصيلة سطرٌ في دفترك: ما لك وما عليك، وتسويةٌ دورية مبيّنة.',
      'fl.sec2': 'كيف يسير <span>العمل</span>', 'fl.sec2lead': 'أربع خطوات، أولاها هذه الاستمارة.',
      'fl.s1t': 'تُرسل بياناتك', 'fl.s1d': 'من الاستمارة أدناه، ونعود إليك لمراجعة الترخيص والاتفاق.',
      'fl.s2t': 'نتفق على الشروط', 'fl.s2d': 'حصّتك وحصّة كباتنك تُضبط في ملفك، وتُشرح لك كاملةً قبل أن توقّع.',
      'fl.s3t': 'تضمّ كباتنك', 'fl.s3d': 'بأكواد دعوةٍ تُصدرها أنت، ويعتمدهم المدير بعد فحص مستنداتهم.',
      'fl.s4t': 'تبدأ الطلبات', 'fl.s4d': 'وتتابع أسطولك من لوحتك، ودفترك يمتلئ مع كل توصيلة.',
      'fl.form': 'استمارة <span>التسجيل</span>', 'fl.formlead': 'دقيقةٌ واحدة — ونعود إليك على جوّالك.',
      'fl.org': 'اسم المنشأة', 'fl.cr': 'رقم السجل التجاري', 'fl.lic': 'رقم ترخيص هيئة النقل',
      'fl.opt': '(إن صدر)', 'fl.opt2': '(اختياري)',
      'fl.person': 'اسم المسؤول', 'fl.phone': 'رقم الجوال', 'fl.choose': 'اختر…',
      'fl.riders': 'كم كابتناً جاهزاً لديك؟',
      'fl.r1': '١ – ٥', 'fl.r2': '٦ – ١٥', 'fl.r3': '١٦ – ٤٠', 'fl.r4': 'أكثر من ٤٠',
      'fl.veh': 'نوع المركبات', 'fl.v1': 'دراجات نارية', 'fl.v2': 'سيارات', 'fl.v3': 'الاثنان',
      'fl.city': 'مدينة التشغيل', 'fl.note': 'ملاحظة',
      'fl.send': 'أرسل عبر واتساب', 'fl.mail': 'أو أرسل بالبريد إلى info@zadgo.co',
      'fl.faq': 'أسئلة <span>يسألها الجميع</span>',
      'fl.q1': 'كم حصّتي من كل توصيلة؟', 'fl.a1': 'تُتفق معك وتُثبَّت في ملفك، ونشرحها كاملةً قبل أن توقّع شيئاً. ولا نكتب رقماً هنا لأن الشروط تختلف من مشغّلٍ لآخر وبحسب حجم أسطولك.',
      'fl.q2': 'هل عليّ رسوم اشتراك؟', 'fl.a2': 'لا رسوم تأسيس. وأي التزامٍ دوري — إن وُجد — يُذكر لك في الاتفاق قبل التوقيع، ولا يُفرض عليك بعده.',
      'fl.q3': 'من يوظّف الكباتن ويتحمّل إقاماتهم؟', 'fl.a3': 'أنت. المنشأة هي صاحبة العلاقة العمّالية مع كباتنها وتتحمّل إقاماتهم وتأميناتهم ومركباتهم — وهذا بالضبط ما يجعل تشغيلهم نظامياً.',
      'fl.q4': 'هل أستطيع فصل كابتن أو ضمّ آخر؟', 'fl.a4': 'نعم. تُصدر كود دعوةٍ لمن تضمّه فيقدّم بمستنداته وتعتمده الإدارة، وتُبلغنا بمن تفصله فيُرفع من أسطولك.',
      'fl.q5': 'ومتى أستلم مستحقاتي؟', 'fl.a5': 'في تسوية دورية مبيّنة سطراً سطراً: كل توصيلة، وما لك وما عليك، والصافي. ويُتفق على الدورة معك.',
      'fl.q6': 'وإن لم يصدر ترخيصي بعد؟', 'fl.a6': 'أرسل استمارتك واكتب «قيد الإصدار» في خانة الترخيص. نتحدّث ونجهّز الاتفاق، ولا يبدأ التشغيل إلا بعد صدوره.',
      'fl.navjoin': 'انضم كابتناً',
    },
    en: {
      'fl.pill': '✦ For licensed companies',
      'fl.h1': 'You run your riders<br><span>we bring the orders</span>',
      'fl.lede': '<b>Your fleet works under your name, and our orders fill its day.</b> An operations board showing your riders alone on the map, and an open ledger line by line.',
      'fl.gate': 'Before you continue: this page is for licensed companies only.',
      'fl.gated': 'The delivery-activity regulations only allow us to contract with a company licensed by the Transport General Authority, or a Saudi individual with their own vehicle and a freelance permit. If you are a rider who wants to work independently, your door is the <a href="/join/">rider sign-up page</a>, not this one.',
      'fl.sec1': 'What you <span>get</span>', 'fl.sec1lead': 'No vague promises — this board works today.',
      'fl.f1t': 'Your riders only', 'fl.f1d': 'A board showing your team and no one else: each rider\'s status, current order, and performance.',
      'fl.f2t': 'Live map', 'fl.f2d': 'See where your riders are right now, and spread them across districts instead of calling one by one.',
      'fl.f3t': 'You add your own riders', 'fl.f3d': 'You issue an invite code, the rider applies with documents — and admin approves. Nobody joins your fleet unchecked.',
      'fl.f4t': 'An open ledger', 'fl.f4d': 'Every delivery is a line: what you are owed and what you owe, with a periodic itemised settlement.',
      'fl.sec2': 'How it <span>works</span>', 'fl.sec2lead': 'Four steps — this form is the first.',
      'fl.s1t': 'You send your details', 'fl.s1d': 'Through the form below; we come back to you to review the licence and agree terms.',
      'fl.s2t': 'We agree the terms', 'fl.s2d': 'Your share and your riders\' share are set in your profile, and explained in full before you sign.',
      'fl.s3t': 'You add your riders', 'fl.s3d': 'With invite codes you issue, approved by admin after their documents are checked.',
      'fl.s4t': 'Orders begin', 'fl.s4d': 'And you follow your fleet from your board while your ledger fills with every delivery.',
      'fl.form': 'Registration <span>form</span>', 'fl.formlead': 'One minute — and we call you back.',
      'fl.org': 'Company name', 'fl.cr': 'Commercial registration number', 'fl.lic': 'Transport Authority licence number',
      'fl.opt': '(if issued)', 'fl.opt2': '(optional)',
      'fl.person': 'Contact person', 'fl.phone': 'Mobile number', 'fl.choose': 'Choose…',
      'fl.riders': 'How many riders are ready?',
      'fl.r1': '1 – 5', 'fl.r2': '6 – 15', 'fl.r3': '16 – 40', 'fl.r4': 'More than 40',
      'fl.veh': 'Vehicle type', 'fl.v1': 'Motorcycles', 'fl.v2': 'Cars', 'fl.v3': 'Both',
      'fl.city': 'Operating city', 'fl.note': 'Note',
      'fl.send': 'Send via WhatsApp', 'fl.mail': 'Or email info@zadgo.co',
      'fl.faq': 'Questions <span>everyone asks</span>',
      'fl.q1': 'What is my share of each delivery?', 'fl.a1': 'It is agreed with you and fixed in your profile, and explained in full before you sign anything. We do not print a number here because terms differ by operator and fleet size.',
      'fl.q2': 'Are there subscription fees?', 'fl.a2': 'No setup fee. Any recurring commitment — if there is one — is stated in the agreement before signing, never imposed afterwards.',
      'fl.q3': 'Who employs the riders and covers their residency?', 'fl.a3': 'You do. The company holds the employment relationship with its riders and covers their residency, insurance and vehicles — which is precisely what makes operating them lawful.',
      'fl.q4': 'Can I remove a rider or add another?', 'fl.a4': 'Yes. You issue an invite code for whoever joins, they apply with documents and admin approves; tell us who you release and they are removed from your fleet.',
      'fl.q5': 'When do I receive my dues?', 'fl.a5': 'In a periodic settlement itemised line by line: every delivery, what you are owed and what you owe, and the net. The cycle is agreed with you.',
      'fl.q6': 'What if my licence has not been issued yet?', 'fl.a6': 'Send the form and write “being issued” in the licence field. We talk and prepare the agreement; operations only begin once it is issued.',
      'fl.navjoin': 'Become a rider',
    },
  };
