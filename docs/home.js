...
(function () {
  ...
  ar: {
    ...
    'kitchen.lead': 'صورٌ حقيقية من مطابخ شركائنا وبأسعارهم هم — لا صور مخزون ولا سعرٌ يتغيّر عند الدفع.',
  ...
  en: {
    ...
    'kitchen.lead': 'Real photos from our partners\u2019 kitchens, at their own prices — no stock images and no price that changes at checkout.',
  ...
  bn: {
    ...
    'kitchen.lead': 'আমাদের পার্টনারদের রান্নাঘরের আসল ছবি, তাদের নিজেদের দামে — স্টক ছবি নয়, আর পেমেন্টে দাম বদলায় না।',
  ...
  ur: {
    ...
    'kitchen.lead': 'ہمارے شراکت داروں کے کچن کی اصل تصاویر، انہی کی قیمتوں پر — نہ اسٹاک تصویر، نہ ادائیگی پر بدلتی قیمت۔',
  ...
  id: {
    ...
    'kitchen.lead': 'Foto asli dari dapur mitra kami, dengan harga mereka sendiri — tanpa foto stok dan tanpa harga yang berubah saat bayar.',
