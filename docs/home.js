...
(function () {
  ...
  ar: {
    ...
    'kitchen.h2': 'من مطبخ <em>أوّل شركائنا</em>',
    'kitchen.lead': 'هذه صورٌ حقيقية من مطعمٍ شريكٍ فعليّ — لا صور مخزون. ما تراه هو ما يصلك.',
    'kitchen.c1': 'فطير بالعسل', 'kitchen.c1d': 'من فطير ستيشن — أوّل شركائنا في المدينة',
    'kitchen.c2': 'شيدر وعسل', 'kitchen.c2d': 'الصورة من المطعم نفسه، بسعره هو',
    'kitchen.c3': 'حلاوة وقشطة', 'kitchen.c3d': 'ونعرض السعرات لكل صنف قبل أن تطلب',
    'kitchen.note': '<b>لماذا صورٌ من مطعمٍ واحد؟</b> لأننا ما زلنا في التجربة، ولا نملك تسعة مطابخ نصوّرها. وصورةٌ من مخزونٍ عالميّ تحت عنوان «من مطابخ مدينتك» كذبةٌ يكشفها القارئ في ثانية.',
    'night.h2': 'نعمل حين <em>تعمل المدينة</em>',
    'night.lead': 'أعلى ساعات المطبخ في المدينة ليست الظهر. هي ما بعد المغرب، وما بعد العشاء، وساعات السحور الطويلة. من يوصّل في تلك الساعات يكسب أكثر، ومن يطبخ فيها يبيع أكثر — ونحن مبنيّون لها.',
    'night.t1': 'قبيل المغرب', 'night.t1d': 'الطلبات تتجمّع قبل الأذان بنصف ساعة — والمطبخ الجاهز يكسبها.',
    'night.t2': 'بعد العشاء', 'night.t2d': 'أطول موجةٍ في اليوم، وأكثر ساعةٍ يحتاج فيها المطعم كابتناً قريباً.',
    'night.t3': '<bdi>١٢ص — ٤ص</bdi>', 'night.t3d': 'ساعات السحور: قليلٌ من المنافسين، وطلبٌ لا ينقطع.',
  ...
  en: {
    ...
    'hero.trial': 'Now in a limited trial with our first partners',
    'hero.h1': 'Your restaurants <span class="gold-word">closer to you</span>',
    'hero.honest': 'The price you see is the price you pay.',
    'hero.where': 'We start from one neighbourhood in Madinah, and grow one neighbourhood at a time.',
    ...
    'kitchen.h2': "From our <em>first partner's kitchen</em>",
    'kitchen.lead': 'These are real photos from an actual partner restaurant — not stock. What you see is what arrives.',
    'kitchen.c1': 'Fateer with honey', 'kitchen.c1d': 'From Fateer Station — our first partner in Madinah',
    ...
    'kitchen.note': '<b>Why photos from a single restaurant?</b> Because we are still in trial and do not have nine kitchens to photograph. A global stock photo under the heading “from your city’s kitchens” is a lie the reader catches in a second.',
    'night.h2': 'We work when <em>the city works</em>',
    'night.lead': "A kitchen's busiest hours in this city are not noon. They are after maghrib, after isha, and the long suhoor hours. Whoever delivers in those hours earns more, and whoever cooks in them sells more — and we are built for them.",
    'night.t1': 'Before maghrib', 'night.t1d': 'Orders pile up half an hour before the call to prayer — the ready kitchen wins them.',
    'night.t2': 'After isha', 'night.t2d': 'The longest wave of the day, and the hour a restaurant most needs a captain nearby.',
    'night.t3': '<bdi>12am — 4am</bdi>', 'night.t3d': 'Suhoor hours: few competitors, and demand that does not stop.',
  ...
  bn: {
    ...
    'hero.trial': 'এখন আমাদের প্রথম পার্টনারদের সাথে সীমিত ট্রায়ালে',
    'hero.h1': 'আপনার রেস্টুরেন্ট <span class="gold-word">আরও কাছে</span>',
    'hero.honest': 'যে দাম দেখেন, সেটাই দেন।',
    'hero.where': 'আমরা মদিনার একটি এলাকা থেকে শুরু করছি, এবং এলাকা ধরে ধরে বাড়ছি।',
    ...
    'kitchen.h2': 'আমাদের <em>প্রথম পার্টনারের রান্নাঘর</em> থেকে',
    'kitchen.lead': 'এগুলো সত্যিকারের পার্টনার রেস্টুরেন্টের আসল ছবি — স্টক ছবি নয়। যা দেখছেন তাই পৌঁছাবে।',
    'kitchen.c1': 'মধু দিয়ে ফাতির', 'kitchen.c1d': 'ফাতির স্টেশন — মদিনায় আমাদের প্রথম পার্টনার',
    ...
    'kitchen.note': '<b>একটি রেস্টুরেন্টের ছবি কেন?</b> কারণ আমরা এখনো ট্রায়ালে, নয়টি রান্নাঘর আমাদের নেই। “আপনার শহরের রান্নাঘর” শিরোনামে বিদেশি স্টক ছবি এমন মিথ্যা, যা পাঠক এক সেকেন্ডেই ধরে ফেলেন।',
    'night.h2': 'শহর যখন কাজ করে, <em>আমরাও তখন</em>',
    'night.lead': 'এই শহরে রান্নাঘরের ব্যস্ততম সময় দুপুর নয়। মাগরিবের পর, এশার পর, আর সেহরির দীর্ঘ ঘণ্টাগুলো। যিনি সেই সময়ে পৌঁছে দেন তিনি বেশি আয় করেন, আর যিনি রান্না করেন তিনি বেশি বিক্রি করেন — আমরা সেজন্যই তৈরি।',
    'night.t1': 'মাগরিবের ঠিক আগে', 'night.t1d': 'আজানের আধা ঘণ্টা আগে অর্ডার জমতে থাকে — প্রস্তুত রান্নাঘরই জেতে।',
    'night.t2': 'এশার পর', 'night.t2d': 'দিনের দীর্ঘতম ঢেউ, আর রেস্টুরেন্টের সবচেয়ে বেশি কাছের ক্যাপ্টেন দরকার তখনই।',
    'night.t3': '<bdi>রাত ১২টা — ৪টা</bdi>', 'night.t3d': 'সেহরির সময়: প্রতিযোগী কম, চাহিদা থামে না।',
  ...
  ur: {
    ...
    'hero.trial': 'ابھی اپنے پہلے شراکت داروں کے ساتھ محدود آزمائش میں',
    'hero.h1': 'آپ کے ریستوران <span class="gold-word">اور قریب</span>',
    'hero.honest': 'جو قیمت دیکھیں، وہی ادا کریں۔',
    'hero.where': 'ہم مدینہ کے ایک محلے سے شروع کر رہے ہیں، اور محلہ بہ محلہ بڑھیں گے۔',
    ...
    'kitchen.h2': 'ہمارے <em>پہلے شراکت دار کے کچن</em> سے',
    'kitchen.lead': 'یہ ایک حقیقی شراکت دار ریستوران کی اصل تصاویر ہیں — اسٹاک نہیں۔ جو دیکھ رہے ہیں وہی پہنچے گا۔',
    'kitchen.c1': 'شہد کے ساتھ فطیر', 'kitchen.c1d': 'فطیر اسٹیشن — مدینہ میں ہمارا پہلا شراکت دار',
    ...
    'kitchen.note': '<b>ایک ہی ریستوران کی تصاویر کیوں؟</b> کیونکہ ہم ابھی آزمائش میں ہیں اور ہمارے پاس نو کچن نہیں۔ «آپ کے شہر کے کچن» کے عنوان تلے عالمی اسٹاک تصویر ایسا جھوٹ ہے جسے قاری ایک سیکنڈ میں پکڑ لیتا ہے۔',
    'night.h2': 'ہم تب کام کرتے ہیں <em>جب شہر کام کرتا ہے</em>',
    'night.lead': 'اس شہر میں کچن کے مصروف ترین اوقات دوپہر نہیں۔ وہ مغرب کے بعد، عشاء کے بعد، اور سحری کے طویل گھنٹے ہیں۔ جو ان اوقات میں پہنچاتا ہے زیادہ کماتا ہے، اور جو پکاتا ہے زیادہ بیچتا ہے — اور ہم انہی کے لیے بنے ہیں۔',
    'night.t1': 'مغرب سے ذرا پہلے', 'night.t1d': 'اذان سے آدھا گھنٹہ پہلے آرڈر جمع ہونے لگتے ہیں — تیار کچن ہی جیتتا ہے۔',
    'night.t2': 'عشاء کے بعد', 'night.t2d': 'دن کی سب سے لمبی لہر، اور وہ گھڑی جب ریستوران کو قریبی کیپٹن سب سے زیادہ چاہیے۔',
    'night.t3': '<bdi>رات ۱۲ — ۴</bdi>', 'night.t3d': 'سحری کے اوقات: مقابلہ کم، اور طلب رکتی نہیں۔',
  ...
  id: {
    ...
    'hero.trial': 'Sedang uji coba terbatas bersama mitra pertama kami',
    'hero.h1': 'Restoranmu <span class="gold-word">lebih dekat</span>',
    'hero.honest': 'Harga yang kamu lihat, itu yang kamu bayar.',
    'hero.where': 'Kami mulai dari satu lingkungan di Madinah, dan tumbuh satu lingkungan demi satu.',
    ...
    'kitchen.h2': 'Dari <em>dapur mitra pertama kami</em>',
    'kitchen.lead': 'Ini foto asli dari restoran mitra yang nyata — bukan stok. Yang kamu lihat itu yang tiba.',
    'kitchen.c1': 'Fateer madu', 'kitchen.c1d': 'Dari Fateer Station — mitra pertama kami di Madinah',
    ...
    'kitchen.note': '<b>Kenapa foto dari satu restoran saja?</b> Karena kami masih uji coba dan belum punya sembilan dapur untuk difoto. Foto stok global di bawah judul “dari dapur kotamu” adalah kebohongan yang ketahuan dalam sedetik.',
    'night.h2': 'Kami bekerja saat <em>kota bekerja</em>',
    'night.lead': 'Jam tersibuk dapur di kota ini bukan siang hari. Tapi setelah magrib, setelah isya, dan jam-jam sahur yang panjang. Yang mengantar di jam itu berpenghasilan lebih, dan yang memasak menjual lebih — dan kami dibangun untuk itu.',
    'night.t1': 'Menjelang magrib', 'night.t1d': 'Pesanan menumpuk setengah jam sebelum azan — dapur yang siap yang menang.',
    'night.t2': 'Setelah isya', 'night.t2d': 'Gelombang terpanjang dalam sehari, dan saat restoran paling butuh kurir di dekatnya.',
    'night.t3': '<bdi>00.00 — 04.00</bdi>', 'night.t3d': 'Jam sahur: sedikit pesaing, permintaan tak berhenti.',
  ...
  function trial() {
    ...
    var note = document.querySelector('.eyebrow [data-i18n]');
    if (note) note.innerHTML = t('hero.trial') || note.innerHTML;
