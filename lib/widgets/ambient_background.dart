...
class _AmbiencePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // ٢. هالة كحلية باردة أسفل اليسار — تباين لوني يمنع الأحادية مع بقاء
    //    الهوية (ذهبي + كحلي). الأخضر السابق (0xFF1FA97A) كان خارج لوحة
    //    العلامة فيبدو دخيلاً على شاشة الدخول؛ الكحلي الأفتح يعطي البرودة
    //    نفسها دون كسر الهوية.
    _glow(
      canvas,
      Offset(w * (0.10 - shift * 0.05), h * 0.82),
      w * 0.80,
      const Color(0xFF2A4E86).withOpacity(0.15),
    );
