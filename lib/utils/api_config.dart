...
// لبنية الخادم — دالة Blaze السحابية (المسار المعتمد) أو ملفات PHP
// (…/notify.php) مرجعاً، دون أي تغيير في الكود أو إعادة بناء منطق.
// (أُلغي بديل Cloudflare Workers بأمر المالك 2026-08-20.)
//
